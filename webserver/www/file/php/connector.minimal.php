...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			'path'          => '/data/my-data',                 // path to files (REQUIRED)
			'URL'           => dirname($_SERVER['PHP_SELF']) . '/data/', // URL to files (REQUIRED)
			'trashHash'     => 't1_Lw',                     // elFinder's hash of trash folder
			'winHashFix'    => DIRECTORY_SEPARATOR !== '/', // to make hash same to Linux one on windows too
			'uploadDeny'    => array('all'),                // All Mimetypes not allowed to upload
			'uploadAllow'   => array('application/x-python-code','text/x-python','application/json', 'text/plain'),// Mimetype `image` and `text/plain` allowed to upload
